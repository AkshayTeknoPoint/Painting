...
class Pager extends Template
{
    ...
    public function __construct(
        ...
        \PaintingTheme\ContactForm\Model\StudentFactory $customFactory, // Add your custom Model
        \PaintingTheme\ContactForm\Model\ResourceModel\Student\CollectionFactory $customdataCollection, // Add your custom Model
        array $data = []
    ) {
    ...
    {
        $this->pageConfig->getTitle()->set(__('Contact Details'));
    ...
    public function getCustomData()
    {
        ...
        $customFactory = $this->customFactory->create();
