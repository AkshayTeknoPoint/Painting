...
namespace PaintingTheme\Zipcode\Model\Import;

use PaintingTheme\Zipcode\Model\Import\CustomImport\RowValidatorInterface as ValidatorInterface;
...
class CustomImport extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{
    ...
    const TABLE_Entity = 'zipcode';
    /** * Validation failure message template definitions * * 
     * @var array 
     * 
     * */
    protected $_messageTemplates = [ValidatorInterface::ERROR_TITLE_IS_EMPTY => 'Message is empty',];
        ...
        if ($table && $listTitle) {
            try {
                $this->countItemsDeleted += $this->_connection->delete(
                    ...
                    $this->_connection->quoteInto(' custom_zipcode_import IN (?)', $ids)
                );
                return true;
            } catch (\Exception $e) {
                return false;
