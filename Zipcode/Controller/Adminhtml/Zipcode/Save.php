...
use PaintingTheme\Zipcode\Model\Zipcode;
...
class Save extends Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('PaintingTheme\Zipcode\Model\Zipcode')->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('zipcode_form_data'); // zipcode_form_data have  Mention in dataprovider.php 
            ...
            $this->dataPersistor->set('zipcode_form_data', $data);
        }
        return $resultRedirect->setPath('*/*');
    }
}
